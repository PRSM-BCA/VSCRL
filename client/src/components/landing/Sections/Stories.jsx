          ...
          >
            ...
            <div className="story">
              ...
              <div className="story-text">
                ...
                <br />could shape the future of my favorite products!"
                <div className="story-text-author">
                  <br /> Opal Darling
                  <br /> Burlington, VT
                </div>
            ...
            <div className="story">
              ...
              <div className="story-text">
                ...
                <br />where products meet actual needs!"
                <div className="story-text-author">
                  <br /> Xander Thomas
                  <br /> Cleveland, OH
                </div>
