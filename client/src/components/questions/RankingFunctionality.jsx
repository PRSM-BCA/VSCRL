...
function RankingExp(props) {
  ...
  // async function listRendererFunc() {
    //  orderBy function to create order by position
    const listRenderer = orderBy(props.rankAnswerObject, "position").map((item) => {
      console.log(item);
      return (
        <Draggable
          axis="y"
  ...
  const onDragEnd = (data) => {
    ...
    // update positions
    const reorderedAnswers = props.rankAnswerObject.map((answer) => {
    ...
    props.setRankAnswerObject(reorderedAnswers);
  };
    ...
    return (
      <div className="rankingAnswer-admin">
        <div className="mainContainer">
          <div className="rankTitle-rankInstruction">
            ...
            <p>
              ...
              rank the priority of their responses (#1 being most important and
              #8 being least important).
              <br />
              <br />
              Users' responses to previous short answer and word cloud questions
              will auto-fill into "Ranking Answer" type.
              <br />
              <br />
        ...
        <div className="adminRankWrapper">
          ...
          />
          {!rankPrompt ? (
            <Link spy={true} smooth={true} offset={0} duration={500}>
              Submit Survey
            </Link>
          ) : (
            <Link
