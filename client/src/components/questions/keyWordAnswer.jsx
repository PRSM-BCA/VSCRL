...
function KeyWordAnswer(props) {
  ...
  }, [getUser, userInfo, currentUser, props.keyWordAnswer, keyWordBank]);
      ...
      <div className="KeyWordAnswer-admin">
        <div className="KeyWordMainWrapper">
          <div className="KeyWord-Instructions">
            ...
            <p>
              <u>User Engagement</u>: Users will select 5 keywords from the nine
              that will appear (one in each bubble).
            </p>
            <p>
              <u>Instructions</u>:
              <br />
          ...
          <div id="gridContent">
            ...
            {count === 5 ? (
              <Link
                ...
                duration={500}
                onClick={() => {
                  props.setKeyWord4(keyWordBank[0])
                  props.setKeyWord5(keyWordBank[1])
                  props.setKeyWord6(keyWordBank[2])
                  props.setKeyWord7(keyWordBank[3])
                  props.setKeyWord8(keyWordBank[4])
                }}
              >
                Enter Question Info
              </Link>
