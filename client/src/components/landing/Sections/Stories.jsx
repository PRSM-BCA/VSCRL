...
import personaPic_1 from "../media/personaPic_1.jpeg";
import personaPic_2 from "../media/personaPic_2.jpeg";
import personaPic_3 from "../media/personaPic_3.jpeg";
          ...
          <div className="carousel-wrapper">
            ...
            >
              <div className="story">
                ...
                <img className="story-image" src={personaPic_3} />
              ...
              <div className="story">
                {/* <div className="story-image-test"></div> */}
                <img className="story-image" src={personaPic_1} />
                <div className="story-text">
              ...
              <div className="story">
                {/* <div className="story-image"></div> */}
                <img className="story-image" src={personaPic_2} />
                <div className="story-text">
